...
export const metadata: Metadata = {
  title: "Body & spa",
  description: `Massage, body treatments, hammam, and bridal spa at ${site.name} — Lahore.`,
};
...
export default function BodySpaServicesPage() {
  return (
    <div className="pt-28">
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl text-white/60">
              Massage, rituals, premium hammam-style care, and bridal packages —
              with clear price, duration, and one-tap booking.
            </p>
      ...
      {bodySpaServiceSections.map((section, si) => (
        <section
          key={section.id}
          id={section.id}
        ...
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            <p className="text-sm text-white/55">
              Want a custom spa day or bridal timeline? Book a consultation and
              we will stitch services together for you.
            </p>
            <Link
